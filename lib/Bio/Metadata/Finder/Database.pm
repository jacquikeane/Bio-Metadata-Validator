...
package Bio::Metadata::Finder::Database;
...
=item have an associated directory structure (see L<Bio::Metadata::Finder::Path::get_hierarchy_root_dir>).
...
sub _build_available_database_names {
  ...
  foreach my $database_name ( @$db_list ) {
    my $root_dir = $self->_path_finder->get_hierarchy_root_dir($database_name);
